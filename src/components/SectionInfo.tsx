  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-24 mt-24">
      <div className="flex flex-col text-center w-96">
        ...
        <span className="text-lg font-semibold pb-4">Pre nových členov</span>
        <span className="">
      ...
      <div className="flex flex-col text-center max-w-screen-sm	w-96">
        ...
        <span className="text-lg font-semibold  pb-4">Tréningy</span>
        <span className="">
      ...
      <div className="flex flex-col text-center max-w-screen-sm	w-96">
        ...
        <span className="text-lg font-semibold pb-4">Komunita</span>
        <span className="">
